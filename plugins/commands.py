    ...
    if usr_cmdall1.startswith("/start subinps"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=cmd.from_user.id,
                    text="**𝙿𝚕𝚎𝚊𝚜𝚎 𝙹𝚘𝚒𝚗 𝙼𝚢 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 𝚝𝚘 𝚞𝚜𝚎 𝚝𝚑𝚒𝚜 𝙱𝚘𝚝🔱!**",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("♻️ 𝙹𝚘𝚒𝚗 𝙼𝚈 𝙲𝚑𝚊𝚗𝚗𝚎𝚕", url=invite_link.invite_link)
                            ],
                            [
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        ...
                        InlineKeyboardButton('𝙶𝚁𝙾𝚄𝙿', url='https://t.me/MMCINEMACHAKKU')
                    ]
                    ]
...
async def bot_info(bot, message):
    ...
    await message.reply(text="Language : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\n𝙶𝚁𝙾𝚄𝙿-1 : <a href='https://t.me/Movie_maniacs00'>Click here</a>\n𝙶𝚁𝙾𝚄𝙿-2 : <a href='https://t.me/Movie_maniacs00'>Click here</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
